...
# MX: looking for path to functions-all-clayton-12-13.r to be able to run the script from
# another directory
...
chr.file <- "/nfs/research2/bertone/user/mxenoph/genome_dir/M_musculus_10/mm10.chrom.sizes"
